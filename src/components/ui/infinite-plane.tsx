...
const InfinitePlane: FC<InfinitePlaneProps> = ({
  planeHeight = 0,
  epsilon = 0.001,
  speed = 1,
  className = "",
...
void main() {
  gl_Position = vec4(a_position, 0.0, 1.0);
    ...
    const resize = () => {
      ...
      // Use the parent element's size, not the canvas's own size
  ...
  return (
    // This outer div takes whatever className is passed (e.g. "absolute inset-0 z-0")
    // The inner div is always absolute inset-0 so the canvas fills it completely
    <div
      role="region"
